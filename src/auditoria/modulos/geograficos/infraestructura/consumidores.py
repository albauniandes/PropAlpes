...
from auditoria.modulos.geograficos.infraestructura.schema.v1.eventos import EventoAuditoriaGeograficoCreada
from auditoria.modulos.geograficos.infraestructura.schema.v1.comandos import ComandoCrearAuditoriaGeografico
        ...
        while True:
            ...
            try:
                with app.app_context():
                    ...
                    comando = CrearAuditoriaGeografico(fecha_creacion, fecha_creacion,
