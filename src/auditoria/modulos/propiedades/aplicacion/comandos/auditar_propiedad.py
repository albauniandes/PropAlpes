...
@dataclass
class CrearAuditoriaPropiedad(Comando):
    fecha_creacion: str
...
class CrearAuditoriaPropiedadHandler(CrearAuditoriaPropiedadBaseHandler):
...
@comando.register(CrearAuditoriaPropiedad)
def ejecutar_comando_crear_propiedad(comando: CrearAuditoriaPropiedad):
    handler = CrearAuditoriaPropiedadHandler()
