...
class MapadeadorEventosDatosGeograficos(Mapeador):
    ...
    def _entidad_a_compania_creada(self, entidad: DatosGeograficosCreados, version=LATEST_VERSION):
        def v1(evento):
            ...
            payload = DatosGeograficosCreadosPayload(
                id_datos_geograficos=str(evento.id_compania),
            ...
            evento_integracion.service_name = 'datos_geograficos'
    ...
    def _entidad_a_datos_geograficos_aprobados(self, entidad: DatosGeograficosAprobados, version=LATEST_VERSION):
        # TODO
        raise NotImplementedError

    def _entidad_a_datos_geograficos_rechazados(self, entidad: DatosGeograficosRechazados, version=LATEST_VERSION):
        # TODO
        raise NotImplementedError
