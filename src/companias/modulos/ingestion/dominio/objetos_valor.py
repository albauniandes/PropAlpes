...
En este archivo usted encontrará los objetos valor del dominio de ingestion
...
from companias.seedwork.dominio.objetos_valor import ObjetoValor, Codigo, Locacion, Nombre, Identificacion
